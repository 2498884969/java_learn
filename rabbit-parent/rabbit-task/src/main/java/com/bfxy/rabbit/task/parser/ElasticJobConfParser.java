...
// 参考https://segmentfault.com/a/1190000019786425
	...
	public void onApplicationEvent(ApplicationReadyEvent event) {
		try {
			...
			for(Iterator<?> it = beanMap.values().iterator(); it.hasNext();) {
				...
				// 	获取接口类型 用于判断是什么类型的任务, 实际情况下，需要便利所有接口
				...
				// https://blog.csdn.net/f641385712/article/details/88683596 BeanDefinitionBuilder
				// https://www.iteye.com/blog/dikar-850124
